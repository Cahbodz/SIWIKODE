...
<section class="detail">
	<div class="container">
		<div class="row offset-1">
			<p style="margin-left: 700px;"><a href="<?php echo base_url(); ?>index.php/rekreasi"> Home</a> /<a href="<?php echo base_url(); ?>index.php/rekreasi"> Wisuda Rekreasi</a> / Detail</p>
			<h2>Daftar Wisata rekreasi Kota Depok</h2>
			<div class="col-sm-2">
			<div class="hovereffect">
		        <img src="../../img/detail1.jpg">
		        <div class="overlay">
		           <a class="info" href="#">Alam Kampung 99 Pepohonan</a>
		        </div>
		    </div>
			</div>
			...
			<div class="hovereffect">
		        ...
		        <div class="overlay">
		           <a class="info" href="#">Water Park Ceria</a>
		        </div>
		    </div>
			</div>
			...
			<div class="hovereffect">
		        ...
		        <div class="overlay">
		           <a class="info" href="#">Masjid Kubah Emas</a>
		        </div>
		    </div>
			</div>
			...
			<div class="hovereffect">
		        ...
		        <div class="overlay">
		           <a class="info" href="#">Fantasy Waterpark</a>
		        </div>
		    </div>
			</div>
			...
			<div class="hovereffect">
		        ...
		        <div class="overlay">
		           <a class="info" href="#">Godong Ijo Depok</a>
		        </div>
		    </div>
			</div>
		</div>
		...
		<div class="row">
			<div class="row text-center">
				<div class="col-sm-5 offset-1">
					...
					<p align="justify">Salah satu kota di Jawa Barat yang memiliki sejuta pesona adalah Depok. Bahkan banyak yang menyebut bahwa panorama alam di wilayah ini masih belum sepenuhnya tereksplor. Depok memiliki banyak spot objek wisata yang keren mulai dari situs budaya, situs yang bersejarah hingga spot foto yang kekinian. Ada juga air terjun yang memanjakan mata dan harus segera dieksplor.</p>
				</div>
				<div class="col-sm-5">
					<div class="alamat">
